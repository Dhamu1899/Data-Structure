...
class Node {
    ...
    /* Function to set data to the current Node */
    ...
    /* Function to get data from the current Node */
    public int getData() {
        return data;
    }
}
...
public class LinkedStackImplement {
    public static void main(String[] args) {
        ...
        /* Creating an object of class linkedStack */
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    System.out.println("Enter an integer element to push");
